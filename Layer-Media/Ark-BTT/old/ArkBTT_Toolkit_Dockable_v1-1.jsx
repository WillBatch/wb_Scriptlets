  ...
  function scriptBuildUI(thisObj) {
    var win =
      thisObj instanceof Panel
        ? thisObj
        : new Window("palette", "Ark BTT Toolkit v1.1", undefined, {
            resizeable: true,
          });
    win.spacing = 0;
    ...
    button1.onClick = function () {
      setupForm(app.project.activeItem, inputField1.text);
    };
...
function setupForm(comp, brush_stroke_comp) {
  ...
  if (comp.selectedLayers.length == 1) {
    ...
    function addFormSetup(brush_comp, currentComp, fill_layer) {
      ...
      //   addFormEffectToLayer(newFormLayer);
