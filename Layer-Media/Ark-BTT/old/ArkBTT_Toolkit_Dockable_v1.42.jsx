  ...
  function scriptBuildUI(thisObj) {
    var win =
      thisObj instanceof Panel
        ? thisObj
        : new Window("palette", "Ark BTT Toolkit v1.42", undefined, {
            resizeable: true,
          });
    win.spacing = 10;
    ...
    button1.onClick = function () {
      app.beginUndoGroup("Undo all form setup function");
...
// function retry(layer) {
//   alert(layer.property("Effects").property(6).property("tc Form-0005").name);
//   layer.property("Effects").property(6).property("tc Form-0005").setValue(100);
//   return;
// }
